  ...
  frnzer.on('chat-update', async (frnazer) => {
      try {
          ...
          const testqq = (from, desk) => {
              frnzer.sendButtons(from, `Pilihan Anda Salah!!`, `Pilih yang bener, jangan ngasal!!`, `Pilih Enable atau Disable`, [{
          ...
          const mentions = (teks, memberr, id) => {
              (id == null || id == undefined || id == false) ? frnzer.sendMessage(from, teks.trim(), extendedText, {
                  contextInfo: {
          ...
          switch (command) {
              ...
              case 'broadcast':
                  ...
                  if (isMedia && !nay.message.videoMessage || isQuotedImage) {
                      ...
                      for (let _ of anu) {
                          nayla.sendMessage(_.jid, buff, image, {
                              quoted: fkontak,
                              caption: `「  *BROADCAST* 」\n\n${ini_bc}`
                          })
                      }
...
Terjemahan Nya : ${res.text}`
              ...
              case 'buttons5':
                  ...
                  prep = await frnzer.prepareMessageFromContent(from, {
                      buttonsMessage
                  }, {})
                  frnzer.relayWAMessage(prep)
                  break
              ...
              case 'tulis':
                  ...
                  frnzer.sendMessage(from, buff, image, {
                      quoted: faketroli,
                      caption: mess.succes
                  }).catch(e => {
...
Ket : Ketik /deltt , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {
                          contextInfo: {
              ...
              case 'infogc':
                  ...
                  jids = []
                  let {
                      owner, subject, subjectOwner, desc, descId, participants, size, descOwner, descTime, creation
                  } = await frnzer.query({
...
*Speed* > ${latensii.toFixed(4)} Second!`
                  frnzer.sendButton(from, inifernazer, 'Creator: Fernazer', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
                      quoted: faketroli
                  })
                  break
              case 'sourcecode':
...
Instagram : https://instagram.com/rasi_tech`
              ...
              case 'bug':
                  ...
                  if (pesan.length > 300) return frnzer.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', text, {
                      quoted: faketroli
                  })
...
*└◪* *Pesan : ${pesan}*`
              ...
              case 'tts':
                  ...
                  if (args.length < 1) return frnzer.sendMessage(from, 'Kode bahasanya mana om?', text, {
                      quoted: faketroli
                  })
                  const gtts = require('./lib/gtts')(args[0])
                  if (args.length < 2) return frnzer.sendMessage(from, 'Textnya mana om', text, {
                      quoted: faketroli
                  })
                  dtt = body.slice(9)
                  ranm = getRandom('.mp3')
...
penggunaan : ${prefix + command } wa 🗿`)
              ...
              case 'sticknime':
                  ...
                  frnzer.sendButton(from, ucapanWaktu, 'Creator: Fernazer', 'NEXT➡', `${prefix}doge`, {
                      quoted: faketroli
                  })
                  break
...
🖇️ Link : ${res.all[0].author.url}`
                  ...
                  imageMessage = (await frnzer.prepareMessageMedia({
                      url: res.all[0].image
                  }, 'imageMessage', {
                  ...
                  iniFernazer = await frnzer.prepareMessageFromContent(from, {
                      buttonsMessage
                  }, {})
...
_*Tunggu Proses Mengirim Media......*_`
              ...
              case 'ayatkursi':
                  ...
                  frnzer.sendButton(from, teks, 'Creator: Fernazer', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
                      quoted: faketroli
                  })
                  break
              case 'doaharian':
...
• @${gelutSkuy.Y} Menolak🤙🏻`, MessageType.text, {
                              quoted: frnazer,
                              contextInfo: {
