...
/******************************* FERNAZER *******************************/
/******************************* LOAD WACONNECT *******************************/
const { WAConnection: _WAConnection, Presence, MessageOptions, Mimetype, WALocationMessage, GroupSettingChange, ChatModification, MessageType } = require('@adiwajshing/baileys');
...
•> Type : ${type}`,
  ...
  frnzer.on('group-participants-update', async (anu) => {
    try {
      ...
      if (anu.action == 'add' && !mem.includes(frnzer.user.jid)) {
        ...
        let v = frnzer.contacts[num] || {
          notify: num.replace(/@.+/, ''),
        };
        anu_user = v.vname || v.notify || num.split('@')[0];
        time_wel = moment.tz('Asia/Jakarta').format('HH:mm');
        teks = `Halo ${anu_user} \n\nNama : \nUmur :\nGender : \nAsal :\n\nSemoga Betah dan jangan lupa isi\nAnd Baca Rules Group\n\nVisit Telegram Channel https://t.me/RasiTechChannel2`;
        buff = await getBuffer(
          `http://hadi-api.herokuapp.com/api/card/welcome?nama=${anu_user}&descriminator=${groupMembers.length}&memcount=${memeg}&gcname=${encodeURI(mdata.subject)}&pp=${pp_user}&bg=https://i.postimg.cc/rFkw8MpX/IMG-20210807-151325.jpg`
        );
        buttons = [
          {
            buttonId: `Fernazer`,
            buttonText: {
              displayText: 'Welcome Bre 🖐',
            },
            type: 1,
          },
        ];
      ...
      if (anu.action == 'remove' && !mem.includes(frnzer.user.jid)) {
        ...
        buff = await getBuffer(
          `http://hadi-api.herokuapp.com/api/card/goodbye?nama=${anu_user}&descriminator=${groupMembers.length}&memcount=${memeg}&gcname=${encodeURI(mdata.subject)}&pp=${pp_user}&bg=https://i.postimg.cc/rFkw8MpX/IMG-20210807-151325.jpg`
        );
        buttons = [
          {
            buttonId: `Fernazer`,
            buttonText: {
              displayText: 'Byee yahaha 👋',
            },
            type: 1,
          },
        ];
  ...
  frnzer.on('chat-update', async (frnazer) => {
    try {
      ...
      const cmod =
        type === 'conversation' && frnazer.message.conversation
          ? frnazer.message.conversation
          : type == 'imageMessage' && frnazer.message.imageMessage.caption
          ? frnazer.message.imageMessage.caption
          : type == 'videoMessage' && frnazer.message.videoMessage.caption
          ? frnazer.message.videoMessage.caption
          : type == 'extendedTextMessage' && frnazer.message.extendedTextMessage.text
          ? frnazer.message.extendedTextMessage.text
          : ''.slice(1).trim().split(/ +/).shift().toLowerCase();
      const prefix = /^[°•π÷×¶∆£¢€¥®™✓=|~zZ+×_*!#$%^&./\\©^]/.test(cmod) ? cmod.match(/^[°•π÷×¶∆£¢€¥®™✓=|~zZ+×_*!#$,|`÷?;:%abcdefghijklmnopqrstuvwxyz%^&./\\©^]/gi) : '/';
      body =
        type === 'conversation' && frnazer.message.conversation.startsWith(prefix)
          ? frnazer.message.conversation
          : type == 'imageMessage' && frnazer.message[type].caption.startsWith(prefix)
          ? frnazer.message[type].caption
          : type == 'videoMessage' && frnazer.message[type].caption.startsWith(prefix)
          ? frnazer.message[type].caption
          : type == 'extendedTextMessage' && frnazer.message[type].text.startsWith(prefix)
          ? frnazer.message[type].text
          : type == 'listResponseMessage' && frnazer.message[type].singleSelectReply.selectedRowId
          ? frnazer.message[type].singleSelectReply.selectedRowId
          : type == 'buttonsResponseMessage' && frnazer.message[type].selectedButtonId
          ? frnazer.message[type].selectedButtonId
          : type == 'stickerMessage' && getCmd(frnazer.message[type].fileSha256.toString('base64')) !== null && getCmd(frnazer.message[type].fileSha256.toString('base64')) !== undefined
          ? getCmd(frnazer.message[type].fileSha256.toString('base64'))
          : '';
      ...
      const ownerNumber = ['6285719821928@s.whatsapp.net']; // Nomor Owner Bre
      const ownerContact = ['6285719821928', '6285719821928']; // Nomor Owner Bre
      ...
      const reply = (teks) => {
        frnzer.sendMessage(from, teks, text, {
          quoted: faketroli,
        });
      };
      const testqq = (from, desk) => {
        frnzer.sendButtons(
          from,
          `Pilihan Anda Salah!!`,
          `Pilih yang bener, jangan ngasal!!`,
      ...
      const costum = (pesan, tipe, target, target2) => {
        frnzer.sendMessage(from, pesan, tipe, {
          quoted: {
            key: {
              fromMe: false,
              participant: `${target}`,
      ...
      const mentions = (teks, memberr, id) => {
        id == null || id == undefined || id == false
          ? frnzer.sendMessage(from, teks.trim(), extendedText, {
              contextInfo: {
      ...
      switch (waktoo) {
        case 0:
          waktoo = 'Waktu Tengah Malam🌚 - Tidur Kak :)';
          break;
        case 1:
          waktoo = 'Waktu Tengah Malam🌚 - Tidur Kak :)';
          break;
        case 2:
          waktoo = 'Waktu Dini Hari🌒 - Tidur Kak :)';
          break;
        case 3:
          waktoo = 'Waktu Dini Hari🌓 - Tidur Kak :)';
          break;
        ...
        case 8:
          ...
          break;
        case 9:
          waktoo = 'Selamat Pagi kak🌝 kak🌝';
          break;
        case 10:
          waktoo = 'Selamat Pagi kak🌝';
          break;
        case 11:
          waktoo = 'Selamat Siang Kak🌞\n - Jangan Lupa Shalat Dzuhur';
          break;
        case 12:
          waktoo = 'Selamat Siang Kak🌞\n - Jangan Lupa Shalat Dzuhur';
          break;
        ...
        case 14:
          ...
          break;
        case 15:
          waktoo = 'Selamat Sore Kak🌝\n -  Jangan Lupa Mandi Dan shalat ashar';
          break;
        case 16:
          waktoo = 'Selamat Sore Kak🌝\n  - Jangan Lupa Mandi Dan shalat ashar';
          break;
        ...
        case 21:
          ...
          break;
        case 22:
          waktoo = 'Selamat Malam🌚\n - Jangan Lupa Beristirahat & Jangan Gadang';
          break;
        case 23:
          waktoo = 'Tengah Malam🌚 \n - Tidur Kak, Ga baik bergadang :)';
          break;
      }
      ...
      if (isGroup && !isVote) {
        if (budy.toLowerCase() === 'vote') {
          ...
          let id_vote = sender ? sender : '6285719821928@s.whatsapp.net';
      ...
      const sendButMessage = (id, text1, desc1, but = [], options = {}) => {
        ...
        frnzer.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options);
      };
      /******************************* FERNAZER *******************************/
      /******************************* CONST MEDIA *******************************/
      ...
      const sendStickerFromUrl = async (to, url) => {
        ...
        download(url, './tmp/stik' + names + '.png', async function () {
          ...
          exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
            ...
            frnzer.sendMessage(to, media, MessageType.sticker, {
              quoted: faketroli,
            });
      ...
      const sendMediaURL = async (to, url, text = '', mids = []) => {
        ...
        download(url, filename, async function () {
          ...
          frnzer.sendMessage(to, media, type, {
            quoted: faketroli,
            mimetype: mime,
            caption: text,
            contextInfo: {
      ...
      if (new Date() * 1 - settingstatus > 1000) {
        ...
        await frnzer.setStatus(`Aktif selama ${uptime} | Mode: Public | User Rasi Tech | Chat Owner Jika Ingin Menambahkan Bot Ke Group`).catch((_) => _);
      ...
      if (isCmd && !isGroup) {
        console.log(color('[ CMD PRIVATE ]'), color(moment(frnazer.messageTimestamp * 1000).format('HH:mm:ss'), 'magenta'), color(`${command} [${args.length}]`, 'cyan'));
      }
      if (!command) console.log(frnazer);
      if (isCmd && isGroup) {
        console.log(
          color('[ CMD GROUP ]'),
          color(moment(frnazer.messageTimestamp * 1000).format('HH:mm:ss'), 'magenta'),
          color(`${command} [${args.length}]`, 'cyan'),
          color('from', 'pink'),
          color(`${userfernazer}`, 'yellow'),
          color('in', 'pink'),
          color(`${groupName}`, 'gold')
        );
      }
      ...
      switch (command) {
        ...
        case 'sider':
          ...
          frnzer
            .messageInfo(from, frnazer.message.extendedTextMessage.contextInfo.stanzaId)
            .then((res) => {
              let anu = [];
              let txt = `• *Iist Sider*\n\n`;
              for (let i = 0; i < res.reads.length; i++) {
                ...
                txt += `• Waktu : ${moment(`${res.reads[i].t}` * 1000)
                  .tz('Asia/Jakarta')
                  .format('HH:mm:ss')}\n\n`;
              }
        ...
        case 'del':
        case 'd':
          frnzer.deleteMessage(from, {
            id: frnazer.message.extendedTextMessage.contextInfo.stanzaId,
            remoteJid: from,
            fromMe: true,
          });
          break;
        ...
        case 'broadcast':
          ...
          if ((isMedia && !nay.message.videoMessage) || isQuotedImage) {
            ...
            for (let _ of anu) {
              frnzer.sendMessage(_.jid, buff, image, {
                quoted: fkontak,
                caption: `「  *BROADCAST* 」\n\n${ini_bc}`,
              });
            }
            ...
            for (let _ of anu) {
              frnzer.sendMessage(_.jid, `*BROADCAST* \n\n${ini_bc}`, text, {
                contextInfo: {
                  mentionedJid: [sender],
                  forwardingScore: 999,
                  isForwarded: true,
        ...
        case 'bcstik':
          ...
          if ((isMedia && !frnazer.message.videoMessage) || isQuotedSticker) {
            ...
            for (let _ of anu) {
              frnzer.sendMessage(_.jid, bc, sticker, {
                quoted: faketroli,
              });
            }
        ...
        case 'bcvideo':
          ...
          if ((isMedia && !frnazer.message.videoMessage) || isQuotedVideo) {
            ...
            bc = await frnzer.downloadMediaMessage(encmedia);
            for (let _ of anu) {
              frnzer.sendMessage(_.jid, bc, video, {
                mimetype: 'video/mp4',
                duration: 359996400,
                quoted: faketroli,
                caption: `*BROADCAST*\n\n${body.slice(9)}`,
        ...
        case 'bcaudio':
          ...
          if ((isMedia && !frnazer.message.audioMessage) || isQuotedAudio) {
            ...
            bc = await frnzer.downloadMediaMessage(encmedia);
            for (let _ of anu) {
              frnzer.sendMessage(_.jid, bc, audio, {
                mimetype: 'audio/mp4',
                duration: 359996400,
                ptt: true,
                quoted: faketroli,
        ...
        case 'upswimage':
          ...
          if (isQuotedImage) {
            ...
            frnzer.sendMessage('status@broadcast', cihcih, image, {
              caption: `${q}`,
            });
            bur = `Sukses Upload Story Image dengan Caption: ${q}`;
            rafli.sendMessage(from, bur, text, {
              quoted: frnazer,
            });
          } else {
        ...
        case 'upswvideo':
          ...
          if (isQuotedVideo) {
            ...
            cihcih = await frnzer.downloadMediaMessage(swsw);
            frnzer.sendMessage('status@broadcast', cihcih, video, {
              caption: `${q}`,
            });
            bur = `Sukses Upload Story Video dengan Caption: ${q}`;
            frnzer.sendMessage(from, bur, text, {
              quoted: frnazer,
            });
          } else {
        ...
        case 'upswgif':
          ...
          frnzer.sendMessage('status@broadcast', buffer6, MessageType.video, {
            mimetype: 'video/gif',
            caption: `${konti}`,
          });
        ...
        case 'upswvoice':
          ...
          if ((isMedia && !frnazer.message.videoMessage) || isQuotedAudio) {
            const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(frnazer).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : frnazer;
            buff = await frnzer.downloadMediaMessage(encmedia);
            frnzer.sendMessage('status@broadcast', buff, audio, {
              mimetype: 'audio/mp4',
              duration: 999999999,
              ptt: true,
            });
...
┣❒ =>
┗━━━•`;
          frnzer.send3Button(from, fernazer, `Time : ${time} ~Rasi Tech`, 'OWNER', `${prefix}owner`, 'SCRIPT BOT', `${prefix}sourcecode`, 'INFO BOT', `${prefix}info`, {
            quoted: faketroli,
            contextInfo: {
              mentionedJid: [sender],
            },
        ...
        case 'menu':
          ...
          frnzer.sendMessage(
            from,
            {
              contentText: `Hai,${userfernazer}${ucapanWaktu}`,
              footerText: '! Gunakan Bot Sebaik-Baiknya !\n\n\n Created By Rasi Tech\n\nOwner : https://wa.me/6285719821928',
              buttons: [
                {
                ...
                {
                  buttonId: `${prefix}infostick`,
                  buttonText: {
                    displayText: 'INFO CMD',
                  },
                  type: 1,
                },
              ],
...
Terjemahan Nya : ${res.text}`;
        ...
        case 'buttons5':
          ...
          buttonsMessage = {
            contentText: `${result}`,
            footerText: 'Kebenaran atau tantangan?',
            buttons: buttons,
            headerType: 1,
          };
          prep = await frnzer.prepareMessageFromContent(
        ...
        case 'komunis':
          ...
          if (((isMedia && !frnazer.message.videoMessage) || isQuotedImage || isQuotedVideo) && args.length == 0) {
            ...
            frnzer.sendMessage(from, hehe, image, {
              quoted: faketroli,
            });
          } else {
        ...
        case 'setcmd':
          if (isQuotedSticker) {
            ...
            addCmd(kodenya, q);
            reply('Join https://t.me/RasiTechChannel2');
          } else {
            reply('tag stickenya');
          }
          break;
...
[ ${args[0]} ] Ketik Y/N untuk menerima atau menolak permainan`;
          ...
          frnzer.sendMessage(from, starGame, MessageType.text, {
            quoted: faketroli,
            contextInfo: {
...
Ket : Ketik /deltt , Untuk Mereset Permainan Yg Ada Di Grup!`,
            text,
            {
              contextInfo: {
...
*Speed* > ${latensii.toFixed(4)} Second!`;
          frnzer.sendButton(from, inifernazer, 'Creator: Rasi Tech', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
            quoted: faketroli,
          });
          break;
        case 'sourcecode':
        case 'sc':
        case 'src':
          frnzer.sendButton(from, `Join Telegram Channel\n\nhttps://t.me/RasiTechChannel`, 'Creator: Rasi Tech', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
            quoted: faketroli,
          });
          break;
        case 'info':
...
• Name: *Rasi Adil Sejahtera*
• Age: *17*
• Class: *12 SMA*
• Hobby: *Coding Script*

Instagram : https://instagram.com/rasi_tech`;
          frnzer.sendButton(from, fernazer, 'Creator: Rasi Tech', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
            quoted: faketroli,
          });
          break;
        case 'owner':
          ...
          yafernazer = await frnzer.sendMessage(
            from,
            {
          ...
          frnzer.sendMessage(from, 'Nih Kak Owner Ku', text, {
            quoted: yafernazer,
          });
          break;
        case 'bug':
          ...
          if (pesan.length > 300)
            return frnzer.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', text, {
              quoted: faketroli,
            });
          var nomor = frnazer.participant;
          const tekst1 = `*◪* *Bug Report*
...
*└◪* *Pesan : ${pesan}*`;
          ...
          frnzer.sendMessage('6281328139682@s.whatsapp.net', options, text, {
            quoted: faketroli,
          });
        ...
        case 'tomp3':
          ...
          exec(`ffmpeg -i ${media} -af equalizer=f=1:width_type=o:width=2:g=30 ${ran}`, (err, stderr, stdout) => {
            ...
            frnzer.sendMessage(from, hah, audio, {
              mimetype: 'audio/mp4',
              ptt: false,
              quoted: faketroli,
            });
        ...
        case 'wame':
          ...
          frnzer.sendMessage(from, options, MessageType.text, {
            quoted: faketroli,
          });
          break;
        case 'toimg':
        case 'img':
          ...
          exec(`ffmpeg -i ${media} ${ran}`, (err) => {
            ...
            frnzer.sendMessage(from, bufferi9nn, image, {
              caption: 'Done bruhh',
            });
            fs.unlinkSync(ran);
          });
        ...
        case 'tts':
          ...
          if (args.length < 1)
            return frnzer.sendMessage(from, 'Kode bahasanya mana om?', text, {
              quoted: faketroli,
            });
          const gtts = require('./lib/gtts')(args[0]);
          if (args.length < 2)
            return frnzer.sendMessage(from, 'Textnya mana om', text, {
              quoted: faketroli,
            });
          dtt = body.slice(9);
          ranm = getRandom('.mp3');
          ...
          dtt.length > 600
            ...
            : gtts.save(ranm, dtt, function () {
                exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
                  ...
                  frnzer.sendMessage(from, bufferg, audio, {
                    quoted: faketroli,
                    ptt: true,
                  });
                  fs.unlinkSync(rano);
        ...
        case 'detikvideo':
          ...
          cokmatane = Number(args[0]);
          hah = fs.readFileSync(media);
          frnzer.sendMessage(from, hah, video, {
            mimetype: 'video/mp4',
            duration: cokmatane,
            quoted: faketroli,
          });
        ...
        case 'emoji':
          if (isBanned) return reply(mess.only.benned);
          if (args.length == 0)
            return reply(`Example: ${prefix + command} wa 🗿
...
penggunaan : ${prefix + command} wa 🗿`);
        ...
        case 'attp':
          ...
          frnzer.sendMessage(from, buffer, sticker, {
            quoted: faketroli,
          });
          break;
        // Case By Fernazer
        ...
        case 'stikergif':
          ...
          if ((isMedia && !frnazer.message.videoMessage) || isQuotedImage) {
            ...
            ffmpeg(media)
              .on('error', (e) => {
                console.log(e);
                frnzer.sendMessage(from, 'Terjadi kesalahan', 'conversation', {
                  quoted: faketroli,
                });
                fs.unlinkSync(media);
              })
              .on('end', () => {
                _out = getRandom('.webp');
                spawn('webpmux', ['-set', 'exif', './stik/data.exif', out, '-o', _out]).on('exit', () => {
                  frnzer.sendMessage(from, fs.readFileSync(_out), 'stickerMessage', {
                    quoted: faketroli,
                  });
                  fs.unlinkSync(out);
                  fs.unlinkSync(_out);
        ...
        case 'sticknime':
          ...
          frnzer.sendButton(from, ucapanWaktu, 'Creator: Rasi Tech', 'NEXT➡', `${prefix}doge`, {
            quoted: faketroli,
          });
          break;
...
🖇️ Link : ${res.all[0].author.url}`;
          ...
          buttons = [
            {
              buttonId: `${prefix}buttonvideo ${res.all[0].url}`,
              buttonText: {
                displayText: '🎥VIDEO',
              },
              type: 1,
            ...
            {
              buttonId: `${prefix}buttonmusic ${res.all[0].url}`,
              buttonText: {
                displayText: '🎵AUDIO',
              },
              type: 1,
          ...
          imageMessage = (
            await frnzer.prepareMessageMedia(
              {
                url: res.all[0].image,
              },
              'imageMessage',
          ...
          iniFernazer = await frnzer.prepareMessageFromContent(
            from,
            {
              buttonsMessage,
            },
        ...
        case 'google':
          ...
          googleIt({
            ...
            .then((results) => {
              ...
              frnzer.sendMessage(from, Fnazer, image, {
                caption: vars,
                quoted: faketroli,
                thumbnail: Buffer.alloc(0),
              });
...
Link : ${res.result.link}`;
        ...
        case 'zoom':
          if (isBanned) return reply(mess.only.benned);
          anu = await fetchJson(`https://anonyzoom.herokuapp.com/`);
          let zoom = `*Join URL : ${anu.Join_URL}*\n\n*Password : ${anu.Password}*\n\n*Start Time : ${anu.Start_Time}*\n\n*Host Key : ${anu.Host_Key}*\n\n*Duration : ${anu.Duration}*`;
          reply(zoom);
...
_*Tunggu Proses Mengirim Media......*_`;
          ...
          try {
            axios.get(`https://nekos.life/api/v2/img/lizard`).then((res) => {
              imageToBase64(res.data.url).then((response) => {
                ...
                frnzer.sendMessage(from, buf, image, {
                  quoted: faketroli,
                  caption: 'Nih',
                });
              });
            ...
            .then((body) => {
              ...
              imageToBase64(pjr)
                .then((response) => {
                  ...
                  frnzer.sendMessage(from, media, image, {
                    quoted: faketroli,
                    caption: 'NIH',
                  });
                })
        ...
        case 'ayatkursi':
          ...
          frnzer.sendButton(from, teks, 'Creator: Rasi Tech', 'KEMBALI KE MENU↩️', `${prefix}menu2`, {
            quoted: faketroli,
          });
          break;
        case 'doaharian':
          frnzer.updatePresence(from, Presence.composing);
          reply(mess.wait);
          asu = await fetchJson('https://api-yogipw.herokuapp.com/api/muslim/doaharian', {
            method: 'get',
          });
          teks = '=================\n';
        ...
        case 'niatsholat':
          reply(mess.wait);
          anu = await fetchJson('https://api-yogipw.herokuapp.com/api/muslim/niatshalat', {
            method: 'get',
          });
          teks = '=================\n';
        ...
        case 'bacaansholat':
          reply(mess.wait);
          anu = await fetchJson('https://api-yogipw.herokuapp.com/api/muslim/bacaanshalat', {
            method: 'get',
          });
          teks = '=================\n';
          for (let i of anu.result) {
        ...
        default:
          if (isGroup && isAntiVO && type == 'viewOnceMessage') {
            ...
            let pe = await frnzer.prepareMessageFromContent(from, msg.message.viewOnceMessage.message, {
              quoted: peq,
            });
          ...
          if (budy.includes('https://chat.whatsapp.com/')) {
            ...
            setTimeout(() => {
              frnzer.groupRemove(from, [kic]).catch((e) => {
...
• @${gelutSkuy.Y} Menolak🤙🏻`,
                MessageType.text,
                {
                  quoted: frnazer,
                  contextInfo: {
                    mentionedJid: [gelutSkuy.Y + '@s.whatsapp.net'],
                  },
                }
              );
              fs.unlinkSync('./tmp/' + from + '.json');
...
Giliran = @${tty.player1.split('@')[0]}
 ...
 ${angka[7]}${angka[8]}${angka[9]}`;
              frnzer.sendMessage(from, ucapan, text, {
                quoted: faketroli,
                contextInfo: {
            ...
            if (budy.startsWith('N')) {
              ...
              naa = ky_ttt.filter((toek) => !toek.id.includes(from));
              ky_ttt = naa;
              frnzer.sendMessage(from, `Yahh @${tty.player2.split('@')[0]} Menolak:(`, text, {
                quoted: faketroli,
                contextInfo: {
...
${ttt}`;
              frnzer.sendMessage(from, ucapan1, text, {
                quoted: faketroli,
                contextInfo: {
